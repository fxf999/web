    ...
    return (
      <div className="padded-container">
        ...
        <h2>1. Information You Provide to Us</h2>
          ...
          <h3>1.1. Information Regarding Your Use of the Services</h3>
          ...
          <h3>1.2. Transactional Information</h3>
            <p>If you purchase products or services from us (e.g., Steem Power), we will collect certain information from you, including your name, address, email address, and information about the product or service you are purchasing. Payments are processed by third-party payment processors (e.g., Stripe and PayPal), so please refer to the applicable processor's terms and privacy policy for more information about how payment information is processed and stored.</p>
          <h3>1.3. Other Information</h3>
        ...
        <h2>2. Information We Collect Automatically</h2>
          <p>When you access or use our Services, we may also automatically collect information about you. <br/>This includes:</p>
        ...
        <h2>3. How We Use Information About You</h2>
          ...
          <ul>
            ...
            <li>Help protect the safety of Steemhunt and our users, which includes blocking suspected spammers, addressing abuse, and enforcing the Steemhunt user agreement and the Terms of Service;</li>
        ...
        <h2>4. How We Share Information</h2>
          ...
          <p>When you submit a post or comment to the Services, visitors to and users of our Services will be able to see the content of your posts and comments, the username associated with your posts or comments, and the date and time you originally submitted the post or comment. Although some parts of the Services may be private or quarantined, they may become public and you should take that into consideration before posting to the Services.</p>
          <p>When other users view your profile, they will be able to see information about your activities on the Services, such as your username, prior posts and comments, Steem Power, and how long you have been a member of the Services.</p>
          ...
          <ul>
            ...
            <li>We may share information if we believe your actions are inconsistent with our user agreements, or other Steemhunt policies, or to protect the rights, property, and safety of ourselves and others;</li>
            <li>We may share information between and among Steemhunt, and its current and future parents, affiliates, subsidiaries, and other companies under common control and ownership; and</li>
        ...
        <h2>5. Ads and Analytics Partners</h2>
          ...
          <h3>5.1. Advertisers and Ad Networks</h3>
            <p>Our ad partners and network may use cookies and use related technologies to collect information when ads are delivered to you on our Services, but Steemhunt does not link to or provide your actual Steemhunt account details to these advertising partners. This means that Steemhunt does not share your individual account browsing habits with advertisers. Steemhunt cannot see advertisers' cookies and advertisers will not see Steemhunt cookies.</p>
          ...
          <p>For more information about how you may control the collection and&sol;or use of information for advertising and analytics purposes, please see &quot;Your Choices.&quot;</p>
        <h2>6. Security</h2>
          <p>We take reasonable measures to help protect information about you from loss, theft, misuse and unauthorized access, disclosure, alteration, and destruction.</p>
        <h2>7. Children under 18</h2>
          <p>Although we welcome users from all walks of life, Steemhunt is not intended or directed at individuals under the age of 18. Therefore, individuals under the age of 18 may not create an account or otherwise access or use the Services.</p>
        <h2>8. Your Choices</h2>
          <p>As a Steemhunt user, you have choices about how to protect and limit the collection, use, and disclosure of, information about you. This includes:</p>
        ...
        <h2>10. Contact Us</h2>
          <p>If you have any questions about this Privacy Policy, please email <a href="mailto:steemhunt@gmail.com">steemhunt@gmail.com</a>.</p>
