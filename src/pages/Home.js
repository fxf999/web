    ...
    <div>
      ...
      <div className="padded-page">
        <div className="split-page">
          ...
          <a href="https://steem.io" target="_blank">What is STEEM? <Icon type="right-circle-o" /></a>
        </div>
      ...
      <div className="padded-page primary-gradient page-3">
        ...
        <a href="https://steem.io" target="_blank" className="bottom-link">What is STEEM? <Icon type="right-circle-o" /></a>
      </div>
      ...
      <div className="padded-page">
        <div className="split-page">
          ...
          <a href="https://www.producthunt.com/team/product-hunt" target="_blank">What is Product Hunt? <Icon type="right-circle-o" /></a>
        </div>
